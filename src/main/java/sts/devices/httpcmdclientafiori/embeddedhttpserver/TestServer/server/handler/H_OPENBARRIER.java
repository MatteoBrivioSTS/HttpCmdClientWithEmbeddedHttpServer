...
public class H_OPENBARRIER extends Controller {
    ...
    public void handle(HttpExchange exchange, Map<String, String> params) throws IOException {
        ...
        System.out.println("H_OPENBARRIER "+ idDevice);
        Tuple<Integer, String> result = s_testServer.getOpenBarrier(idDevice);
